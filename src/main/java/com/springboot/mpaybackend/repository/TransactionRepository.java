...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
    ...
    @Query("SELECT t FROM Transaction t, Client c, Merchant m, ClientCard cc WHERE (:id is null or t.id = :id) " +
            ...
            "AND (t.deleted = FALSE)")
    Page<Transaction> findByFilter(PageRequest of, Long id, String orderId, String terminalId, String phone, String status, String startDate, String endDate, String type, String pan, String last4);
    ...
    @Query("SELECT t FROM Transaction t, Client c, Merchant m, ClientCard cc WHERE (:id is null or t.id = :id) " +
            ...
            "AND (:startDate is null OR :endDate is null OR (t.transactionDate >= :startDate AND t.transactionDate <= :endDate ))" +
            "AND (t.deleted = FALSE)")
    Page<Transaction> findByFilterAndMerchant(PageRequest of, Long id, String orderId, String terminalId, String phone, String status, String startDate, String endDate, String username, String type, String pan, String last4);
    ...
    @Query("SELECT t FROM Transaction t, Client c, Merchant m, ClientCard cc WHERE (:id is null or t.id = :id) " +
            ...
            "AND (:startDate is null OR :endDate is null OR (t.transactionDate >= :startDate AND t.transactionDate <= :endDate ))" +
            "AND (t.deleted = FALSE)")
    Page<Transaction> findByFilterAndClient(PageRequest of, Long id, String orderId, String terminalId, String phone, String status, String startDate, String endDate, String username, String type, String pan, String last4);
}
